...
# Tag as "latest"
docker tag operations-portal asia.gcr.io/order-management-system/orders-app:COMMIT_TAG 
docker push asia.gcr.io/order-management-system/orders-app:COMMIT_TAG 
